...
const fMb1 = () => {simulation.force('charge', d3.forceManyBody().strength(-5000))};
...
const fx1 = () => {simulation.force('x', d3.forceX(width / 2).strength(0.006))};
...
const fy1 = () => {simulation.force('y', d3.forceY(height / 2).strength(0.006))};
const fy2 = () => {simulation.force('y', d3.forceY(height / 2).strength(0.060))};
const fy3 = () => {simulation.force('y', d3.forceY(height / 2).strength(0.085))};
...
// Функция для обновления информации о графе
