...
*/			
	...
	simulation.force("link", d3.forceLink(links).id(d => d.id).distance(10).links(links)); //distance(150)
	simulation.force("link", d3.forceLink(links_parent).id(d => d.id).distance(15).links(links_parent)); //distance(150)
