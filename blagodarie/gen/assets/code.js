...
function calcX1(d){
	const sourceX = (d.source.x < 30 && width<900 ? 30 : d.source.x < 0 && width<900 ? 0 : d.source.x < -30 && width>900 ? 0 : (d.source.x > width-30 && width<900 ? width-30 : d.source.x > width-30 && width>900 ? width-30 : d.source.x)); //везде нули
	const targetX = (d.target.x < 30 && width<900 ? 30 : d.target.x < 0 && width<900 ? 0 : d.target.x < -30 && width>900 ? 0 : (d.target.x > width-30 && width<900 ? width-30 : d.target.x > width-30 && width>900 ? width-30 : d.target.x));
