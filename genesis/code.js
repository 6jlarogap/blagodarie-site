...
*/	
	const simulation = d3.forceSimulation(nodes)
		...
		.force("link", d3.forceLink(links).id(d => d.id).iterations(100).distance(300).strength(1))
//		.force("charge", d3.forceManyBody().strength(-10000).distancemax(100))
		.force("collide", d3.forceCollide().strength(1).radius(20));//.iterations(1));//radius 80  strength(0.6)
...
//		simulation.force("center", d3.forceCenter(width / 2, height / 2))
//		simulation.force("link", d3.forceLink(links).id(d => d.id).distance(10)); //strength(-0.005));
//		simulation.force("charge", d3.forceManyBody()); //.strength(-1050));
...
//		simulation.force("center", d3.forceCenter(width / 2, height / 2))
		simulation.force("link", d3.forceLink(links).id(d => d.id).distance(10).strength(1));
