...
*/
	if(width<900){
		...
		simulation.force("charge", d3.forceManyBody().strength(-1633280).distanceMax(5500));
		simulation.force("x", d3.forceX(width / 2).strength(0.7));
		simulation.force("y", d3.forceY(height / 2).strength(0.7));		
